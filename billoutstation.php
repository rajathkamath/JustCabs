...
$qux="select * from outplace where pvalue='$dropto'";
...
<center>
 ...
 <div class="column"><center><h1><font color="green">INVOICE</font></h1></center><img src="images/invoice.jpg" alt="Mountains" style="width:75%">
 </div>
  <div class="column">
